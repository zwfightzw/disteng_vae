...
flags.DEFINE_string(
    ...
    default="./disentangled_vae/logs/{timestamp}",
...
flags.DEFINE_string(
    "model_dir",
    default="./disentangled_vae/models/{timestamp}",
...
def main(argv):
  ...
  write_log(global_step, '%s/log_infor.txt'%(FLAGS.logdir))
  write_log(now, '%s/log_infor.txt' % (FLAGS.logdir))
